...
<template>
  <main class="pt-10 pb-4 md:pt-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="flex flex-col items-start text-left">
        ...
        <!-- Headline -->
        <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold lg:tracking-tight text-text-light leading-tight">
          Track Calories.<br />
    ...
    <!-- App banner image — full width below hero -->
